...
/**
 * @author arvind
 * This class is the driver (main class) for Assignment 6.3 task 10. This is the 
 * first point of entry into the map reduce program. In this assignment, we take as
 * input a file containing television sales data. We have to calculate the top 3 states for 
 * each company where the sales was maximum 
 *  
 */
